...
\captionsetup[listing]{labelformat=empty} % Убираем стандартный формат меток для caption

% Новая команда для caption с "Листинг n"
...
%\setlist[enumerate,3]{label=\arabic{enumi}.\arabic{enumii}.\arabic*.} % Третий уровень
